...
Над текстом резюме/вакансии проводится очистка: удаляются лишниие символы, стоп-слова, ссылки и т. п. Таким образом, текст сводится к набору фраз. 
...
Для каждого понятия, представляющего, интерес, происходит его поиск в графе понятий. В случае успеха от найденного понятия происходит движение по графу к его родителям и дальше, пока есть родители. Понятия, через которые прошло это движение объединяются и выводятся ка результат.
