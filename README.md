...
* Для создания крупной системы (если окажется, что небольшой системы будет недостаточно) потребуется создать маленький язык программирования и некоторые средства работы с ним. Здесь нужны 1-2 человека, имевших опыт с редакторами кода и создании интепретаторов/компиляторов. 
