...
* Система уже работает хорошо, но требуются специалисты (3-5 человек), которые разбираются в специфике рынка в представляющих интерес областях (например, общепит, документооборот). Они должны помочь расширить граф понятий, более адекватно его структурировать.
