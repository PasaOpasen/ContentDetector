...
1. Если произошло совпадение с каким-то навыком, этот навык выводит. Если произошло совпадение с каким-то маркером, этот маркер всё равно приведёт к одному или нескольким навыкам, которые выведутся.

**Примечание**: ввиду использования стемминга нет необходимость записывать/запоминать все вариации слова с учётом падажей и частей речи. Слова, связанные с английским языком, из фраз "хорошо знаю **английскИЙ**", "читаю статьи на **англискОМ**", "владею **англискИМ** языком" будут сведены к одной и той же основе "англиск" и отнесены к навыку владения англиским. Использует стемминг вместо лемматизации, посколько стемминг значительно быстрее и более качественно сводится к основе; при лемматизации же для слов "общаться" и "общение" основа будет совершенно разная, так как это разные части речи.
